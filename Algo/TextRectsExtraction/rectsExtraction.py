...
receiptPath = 'D:\\X-tras\\ReceiptsInc\\receiptsImages\\imageTech.png'
receiptOrigin = cv2.imread(receiptPath, cv2.IMREAD_GRAYSCALE)  # image receipt load
...
ax = plt.gca()
for rect in rects:
    ax.add_patch(Rectangle((rect[0], rect[1]-1), rect[2], rect[3]+1, linewidth=1, edgecolor='r', facecolor='none'))
